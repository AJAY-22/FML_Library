...
model.train(X, y, validation_data=(X_val, y_val),
            epochs=5, batch_size=128, print_every=10000000)
...
Changes to be made:
1. Model name changed to Neural_Networks
2. File name as Neural_Networks
3. Train as fit
4. By default if print_every is not given as parameter, it should not print anything 
5. Remove print after every epoch as well
6. Make a documentation on Blog.docx
